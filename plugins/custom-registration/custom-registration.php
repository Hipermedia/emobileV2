    ...
    <form action="<?php $_SERVER['REQUEST_URI'] ?>" method="post">
  		<div class="form-group">
  		  <div class="input-group">
  		  	...
  		  	<input class="form-control" placeholder="Nombre Completo" type="text" name="fname" value="<?php echo (isset($_POST['fname']) ? $fname : null) ?>">
  		  </div>
  		  <div class="input-group">
  		  	<!-- <label for="email">Correo <strong>*</strong></label> -->
  		  	<div class="input-group-addon"><i class="fa fa-envelope"></i></div>
  		  	<input class="form-control" placeholder="Correo" type="text" name="email" value="<?php echo (isset($_POST['email']) ? $email : null) ?>">
  		  </div>
  		  <div class="input-group">
  		  ...
  		  <div class="input-group">
  		  	...
  		  	<input class="form-control" placeholder="Ciudad" type="text" name="ciudad" value="<?php echo (isset($_POST['ciudad']) ? $ciudad : null) ?>">
  		  </div>
  		  <div class="input-group">
  		  ...
  		  <input type="submit" class="btn btn-default" name="submit" value="Registrarse"/>
  		</div>
	</form>
<?php
}
